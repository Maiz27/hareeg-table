...
///
/// Offers a replay (fresh board, same lesson) and the way back to the
/// practice hub. Rendered by the game table's overlay stack in practice mode;
/// match overlays (round result, score) never show during a lesson.
