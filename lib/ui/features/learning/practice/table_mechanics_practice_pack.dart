...
/// Table mechanics guided-practice scripts in checklist order.
///
...
abstract final class TableMechanicsPracticePack {
  ...
  static PracticeLessonScript pendingDiscard() {
    ...
    return PracticeLessonScript(
      ...
      boardAuditSpec: PracticeScriptAuthoring.southOpened51OneDeal,
      introActionIds: [
    ...
    return PracticeLessonScript(
      ...
      steps: [
        ...
        PracticeStep(
          ...
          isDemonstrated: PracticeScriptAuthoring.tableHolds(PlayerSeat.west, {
            kingClubs.id,
          }),
  ...
  static PracticeLessonScript sequenceCover() {
    ...
    return PracticeLessonScript(
      ...
      taughtMelds: [
        {jackDiamonds.id, queenDiamonds.id, eightDiamonds.id},
      ],
      buildSnapshot: () => PracticeBoard.build(
        // A pre-opened hand deals the real count: 14 dealt minus the six
        // cards already placed on the table.
  ...
  static PracticeLessonScript coverDiscardBlock() {
    ...
    return PracticeLessonScript(
      ...
      // The trapped ten is never played: the whole hand stays meld-free.
      taughtMelds: const [],
      buildSnapshot: () => PracticeBoard.build(
        southHand: [
          tenHearts,
  ...
  static PracticeLessonScript jokerIdentity() {
    ...
    return PracticeLessonScript(
      ...
      taughtMelds: [
        {sevenClubs.id, sevenHearts.id, joker.id},
      ],
      buildSnapshot: () => PracticeBoard.build(
        // A pre-opened hand deals the real count: 14 dealt minus the six
        // cards already placed on the table.
      ...
      steps: [
        ...
        PracticeStep(
          ...
          allows: PracticeScriptAuthoring.playsJokerMeldExactly({
            sevenClubs.id,
            sevenHearts.id,
            joker.id,
          }),
  ...
  /// discard, because a joker cannot be thrown away during normal play (only
  /// a closing throw may be a joker).
  static PracticeLessonScript jokerReplacement() {
    ...
    return PracticeLessonScript(
      ...
      taughtMelds: [
        {sevenDiamonds.id, eightHearts.id, tenHearts.id},
      ],
      buildSnapshot: () => PracticeBoard.build(
        // A pre-opened hand deals the real count: 14 dealt minus the six
        // cards already placed on the table.
      ...
      steps: [
        ...
        PracticeStep.kinds(
          ...
          // Group 0: the real seven you hold. Group 1: the table joker it
          // reclaims.
          highlightGroups: [
            {sevenDiamonds.id},
            {joker.id},
        ...
        PracticeStep(
          ...
          allows: (action) =>
              ...
              PracticeScriptAuthoring.playsExactly({
                eightHearts.id,
                tenHearts.id,
                joker.id,
              })(action) ||
              PracticeScriptAuthoring.playsJokerMeldExactly({
                eightHearts.id,
                tenHearts.id,
                joker.id,
              })(action),
