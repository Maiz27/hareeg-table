...
class AppStrings {
  ...
  String cpuTurnSafetyCapReached(int limit, PlayerSeat seat) {
    return isRtl
        ? 'توقف دور الكمبيوتر بعد $limit حركة عند ${seatLabel(seat)}.'
        : 'CPU turn safety cap $limit reached at ${seatLabel(seat)}.';
  }

  String cpuTurnPaused(PlayerSeat seat) {
    return isRtl
        ? 'توقف دور الكمبيوتر عند ${seatLabel(seat)}.'
...
const _arabicValues = {
  ...
  'fastCpuTurns': 'لعب سريع للكمبيوتر',
  ...
  'feelDescription':
      'ضبط الاهتزازات، التنبيهات الصوتية، وسرعة تفكير الكمبيوتر.',
  ...
  'beginner': 'كمبيوتر مبتدئ',
  'casual': 'كمبيوتر متوسط',
  'skilled': 'كمبيوتر محترف',
  'expert': 'كمبيوتر خبير جداً',
  ...
  'onboardingReadyBody':
      'يمكنك تعديل مستويات ذكاء الكمبيوتر، تبديل سمات الطاولة والأوراق، أو المرور عبر الدروس التعليمية الموجهة لإتقان اللعبة وتفادي العقوبات الثقيلة.',
  ...
  'practiceBenchmarkSummary':
      'لاحظ كيف يراقب الكمبيوتر حالة نزولك ويغير طريقته إلى أسلوب دفاعي حذر.',
  ...
  'practiceBenchmarkStep4':
      'اكتمل الدرس. لاحظ كيف أن نجاحك في النزول الأول يغير حسابات الكمبيوتر ويجبره على التحول للعب دفاعي حذر تفادياً لتركيباتك.',
  'practiceSeqCoverStep1':
