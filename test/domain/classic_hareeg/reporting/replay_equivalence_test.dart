...
void main() {
  ...
  for (final expected in cases) {
    ...
    test('seed $seed replays exactly as the pre-refactor implementation did', () {
      ...
      expect(actual.mismatches, (unchecked['mismatches']! as List).cast<String>());
      ...
      final checked = expected['checkedAgainstFinalState']! as Map<String, Object?>;
  ...
  test('the replay package applies actions and crosses rounds in one place each', () {
